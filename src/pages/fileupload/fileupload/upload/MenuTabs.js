...
import SendDocModal from "../SendDoc";
import BackdropOverlay from "./BackdropOverlay";
import DeleteFileConfirmationPopup from "./DeleteConfirmationPopup"; // Import the DeleteConfirmationPopup component
...
const CustomizedMenus = ({
  ...
  const handleShareOrSend = () => {
    if (selectedFile && selectedFile.pk) {
      ...
      if (fileUrl && fileId) {
        setIsSendDocModalOpen(true); // Open the modal
      } else {
              ...
              <React.Fragment>
                <Button
                  ...
                  sx={{
                    ...
                    "&:hover": { backgroundColor: "contained", color: "white" },
                  }}
                  onClick={() => {
                    onOpenDocument();
                    popupState.close();
            ...
            {(popupState) => (
              <React.Fragment>
                ...
                <Menu {...bindMenu(popupState)}>
                  ...
                  {/* Wrap "Remove" MenuItem with DeleteConfirmationPopup */}
