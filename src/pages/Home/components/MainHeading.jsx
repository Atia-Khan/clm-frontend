...
{/* {selectedFile && ( */}
          {/* <Typography variant="body2" style={{ marginTop: '5px' }}>
            <p style={{color:'gray'}}>Selected file is : {selectedFile.name}</p>
          </Typography> */}
        
{/* <UploadButton   component="label" color="primary"
                variant="contained" href="/signup" style={{backgroundColor:'#03a1d8',  fontWeight:'bold'}}>
        Select a document
        {/* <input
          type="file"
          style={{ display: 'none' }}
  ...
  // color="primary"
  variant="contained"
  style={{ backgroundColor: '#03a1d8', fontWeight: 'bold', color:'white'}} className="font-body"
>
  Select a document
</UploadButton>
